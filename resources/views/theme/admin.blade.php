                                ...
                                <div class="container-fluid">
                                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                            <li class="nav-item ">
                                                <a class="nav-link" href="{{ url('/') }}">Menu inicial</a>
                                            </li>
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu bg-dark">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ route('divisiones.index') }}">Divisiones</a>
                                    </li>
                                    <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('solicitud-estados.index') }}">Solicitud-estados</a>
                            </li>
                            <li class="nav-item dropdown">
